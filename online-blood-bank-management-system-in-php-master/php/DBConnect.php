...
class DBConnect {
    ...
    public function auth(){
        ...
        if(! isset($_SESSION['username'])){
            header("Location: http://localhost/blood%20donation/Blood-Bank-Management-System/online-blood-bank-management-system-in-php-master/");
        }       
    }
    public function authLogin(){
        session_start();
        if(isset($_SESSION['username'])){
            header("Location: http://localhost/blood%20donation/Blood-Bank-Management-System/online-blood-bank-management-system-in-php-master/home.php");
        }
    }
    ...
    public function logout(){
        session_start();
        session_destroy();
        header("Location: http://localhost/blood%20donation/Blood-Bank-Management-System/online-blood-bank-management-system-in-php-master/index.php");
    }
